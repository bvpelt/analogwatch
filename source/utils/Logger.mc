...
class Logger {
  ...
  function setMinLevel(level as Lang.Number) as Void { _minLevel = level; }

  function setEnabled(enabled as Lang.Boolean) as Void { _enabled = enabled; }

  private function log(source as Lang.String, level as Lang.String,
                       levelValue as Lang.Number,
                       message as Lang.String) as Void {
...
function getLogger() as Logger { return Logger.getInstance(); }
